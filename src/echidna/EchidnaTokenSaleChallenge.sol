...
import "../CTF/TokenSaleChallenge.sol";
...
contract EchidnaTest is TokenSaleChallenge {
    TokenSaleChallenge private tokenSaleChallenge;

    function EchidnaTest() public payable TokenSaleChallenge(msg.sender) {}
